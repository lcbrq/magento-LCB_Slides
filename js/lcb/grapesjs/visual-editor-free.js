document.observe('dom:loaded', function () {
    ...
    function getInitialFreeHtml() {
        return '<section class="lcb-free-banner-root">' +
            '<div class="lcb-free-banner-stage">' +
                '<div data-gjs-type="text" class="lcb-free-layer lcb-free-heading" style="left:465px;top:86px;position:absolute;">Nagłówek</div>' +
                '<div data-gjs-type="text" class="lcb-free-layer lcb-free-text" style="left:516px;top:162px;position:absolute;">Tekst banera</div>' +
                '<a data-gjs-type="text" href="#" class="lcb-free-layer lcb-free-button" style="left:526px;top:212px;position:absolute;">Button</a>' +
            '</div>' +
        '</section>';
    }
            ...
            blocks: [
                {
                    id: 'lcb-free-heading',
                    label: 'Free Heading',
                    content: '<div data-gjs-type="text" class="lcb-free-layer lcb-free-heading" style="left:120px;top:80px;position:absolute;">Nagłówek</div>'
                },
                {
                    id: 'lcb-free-text',
                    label: 'Free Text',
                    content: '<div data-gjs-type="text" class="lcb-free-layer lcb-free-text" style="left:120px;top:150px;position:absolute;">Tekst banera</div>'
                },
                {
                    id: 'lcb-free-button',
                    label: 'Free Button',
                    content: '<a data-gjs-type="text" href="#" class="lcb-free-layer lcb-free-button" style="left:120px;top:220px;position:absolute;">Button</a>'
                },
                {
                    id: 'lcb-free-image',
                    label: 'Free Image',
                    content: '<img src="" alt="" class="lcb-free-layer lcb-free-image" style="left:120px;top:280px;position:absolute;" />'
                }
            ]
        }
    });
    ...
    function setFreeEditorDefaultZoom() {
        ...
        zoom = Math.floor((availableWidth / gridSize.width) * 100);
